...
HD_PWD='C:/Users/Hannah/Desktop/MDP_CNN_Verilog/SimpleCNN/Power_CONV_layer/Power_CONV_layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_layer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_layer.tcl
