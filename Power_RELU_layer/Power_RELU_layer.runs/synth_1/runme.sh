...
HD_PWD='C:/Users/Hannah/Desktop/MDP_CNN_Verilog/SimpleCNN/Power_RELU_layer/Power_RELU_layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log relu_layer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source relu_layer.tcl
