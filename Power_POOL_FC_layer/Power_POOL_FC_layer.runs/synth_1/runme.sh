...
HD_PWD='C:/Users/Hannah/Desktop/MDP_CNN_Verilog/SimpleCNN/Power_POOL_FC_layer/Power_POOL_FC_layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pool_layer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pool_layer.tcl
