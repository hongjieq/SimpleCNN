...
HD_PWD='C:/Users/Hannah/Desktop/MDP_CNN_Verilog/SimpleCNN/Power_POOL_FC_layer/Power_POOL_FC_layer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pool_layer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pool_layer.tcl -notrace
