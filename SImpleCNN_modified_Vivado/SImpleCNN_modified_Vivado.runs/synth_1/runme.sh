...
HD_PWD='C:/Users/Hannah/Desktop/MDP_CNN_Verilog/SimpleCNN/SImpleCNN_modified_Vivado/SImpleCNN_modified_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleCNN_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simpleCNN_tb.tcl
