...
HD_PWD='C:/Users/Hannah/Desktop/MDP_CNN_Verilog/SimpleCNN/SImpleCNN_modified_Vivado/SImpleCNN_modified_Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleCNN_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simpleCNN_tb.tcl -notrace
